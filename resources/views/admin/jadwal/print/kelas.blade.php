...
<title>Jadwal Pelajaran – Kelas {{ $kelas->nama }}</title>
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .doc-header img { width: 60px; height: 60px; object-fit: contain; flex-shrink: 0; }
  ...
  .tahun-badge {
    ...
    font-size: 11px; font-weight: 600; border: 1px solid #fde68a;
  }
  ...
  .kelas-nama { font-size: 14px; font-weight: 700; color: #0f172a; }
  .kelas-meta { font-size: 11px; color: #64748b; margin-top: 1px; }
  ...
  .hari-title {
    ...
    padding: 4px 0 4px 8px; border-left: 3px solid #8b5cf6; margin-bottom: 6px;
  }
  ...
  @media print {
    ...
    .kelas-bar { background: #f0f0f0 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
...
<div class="page-wrapper">
  ...
  {{-- Toolbar --}}
  <div class="toolbar">
    <span>Pratinjau Cetak &mdash; Jadwal Kelas {{ $kelas->nama }}</span>
  ...
  <div class="doc">
    ...
    <div class="kelas-bar">
      ...
      <div>
        <div class="kelas-nama">Kelas {{ $kelas->nama }}</div>
        <div class="kelas-meta">
          {{ $jadwal->flatten()->count() }} JP/minggu
          &nbsp;·&nbsp;
          {{ $jadwal->count() }} hari belajar
          &nbsp;·&nbsp;
          {{ $jadwal->flatten()->pluck('guru_id')->unique()->count() }} guru
        </div>
      </div>
    </div>
    ...
    <div class="empty-state">
      <p>Tidak ada jadwal untuk kelas ini pada tahun ajaran yang dipilih.</p>
    </div>
    @else
    <div class="content">
