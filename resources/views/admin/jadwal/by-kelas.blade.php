...
@section('breadcrumb')
    ...
    <i data-lucide="chevron-right" class="w-3 h-3"></i><span>Per Kelas</span>
@endsection
...
<div class="flex items-center justify-between mb-5">
    ...
    <a href="{{ route('admin.kelas.index') }}" class="btn-secondary text-sm">
...
<form method="GET" class="flex items-center gap-2 mb-5">
    ...
    <a href="{{ route('admin.jadwal.by-kelas') }}" class="btn-secondary text-sm flex-shrink-0">
...
<!-- Kelas selector tabs -->
<div x-data="{ activeKelas: {{ $kelasId ?? $kelasList->first()->id }} }" class="space-y-5">
    ...
    <div x-show="activeKelas === {{ $kelas->id }}" x-transition.opacity.duration.150ms>
        <div class="card overflow-hidden">
            <div class="flex items-center justify-between px-5 py-4 border-b border-slate-100 dark:border-zinc-700/50">
                ...
                <a href="{{ route('admin.jurnal.index', ['kelas_id' => $kelas->id]) }}"
